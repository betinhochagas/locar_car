      ...
      <Dialog open={open && !selectedService} onOpenChange={onOpenChange}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-3 pt-4">
            ...
            <Button
              variant="outline"
              className="w-full h-auto py-6 flex flex-col items-start gap-2 hover:bg-primary/5 hover:border-primary transition-all"
            ...
            >
              <div className="flex items-center gap-3 w-full">
                ...
                <div className="flex-1 text-left">
                  <div className="font-semibold text-lg">Alugar um Veículo</div>
            ...
            >
              <div className="flex items-center gap-3 w-full">
                ...
                <div className="flex-1 text-left">
                  <div className="font-semibold text-lg">Investir em Frota</div>
                  <div className="text-sm text-muted-foreground">
